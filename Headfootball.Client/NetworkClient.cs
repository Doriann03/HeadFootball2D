...
namespace Headfootball.Client
{
    public class NetworkClient
    {
        ...
        public event Action<string, bool>? OnRoomJoined;
        ...
        public event Action<List<StatsPayload>>? OnLeaderboardReceived;
                ...
                try
                {
                    ...
                    switch (msg.Type)
                    {
                        ...
                        case MessageType.LoginFail:
                            var loginResult = JsonConvert.DeserializeObject<LoginResultPayload>(msg.Payload!);
                            if (loginResult != null) OnLoginResult?.Invoke(loginResult);
                            break;
                        case MessageType.RoomList:
                            var roomList = JsonConvert.DeserializeObject<RoomListPayload>(msg.Payload!);
                            if (roomList?.Rooms != null) OnRoomList?.Invoke(roomList.Rooms);
                            break;
                        case MessageType.RoomJoined:
                            var joinPayload = JsonConvert.DeserializeObject<JoinRoomPayload>(msg.Payload!);
                            if (joinPayload != null) OnRoomJoined?.Invoke(joinPayload.RoomId, joinPayload.AsSpectator);
                            break;
                        ...
                        case MessageType.StatsResponse:
                            var stats = JsonConvert.DeserializeObject<StatsPayload>(msg.Payload!);
                            OnStatsReceived?.Invoke(stats);
                            break;
                        case MessageType.LeaderboardResponse:
                            var lb = JsonConvert.DeserializeObject<List<StatsPayload>>(msg.Payload!);
                            if (lb != null) OnLeaderboardReceived?.Invoke(lb);
                            break;
                    }
                }
                catch { break; }
        ...
        public void SendLogin(string username, string password) =>
            Send(new NetworkMessage
            {
                ...
                Payload = JsonConvert.SerializeObject(new LoginPayload { Username = username, Password = password })
            });
        ...
        public void SendRegister(string username, string password) =>
            Send(new NetworkMessage
            {
                ...
                Payload = JsonConvert.SerializeObject(new RegisterPayload { Username = username, Password = password })
            });
        ...
        public void SendJoinRoom(string roomId, bool asSpectator = false) =>
            Send(new NetworkMessage
            {
                ...
                Payload = JsonConvert.SerializeObject(new JoinRoomPayload { RoomId = roomId, AsSpectator = asSpectator })
            });
        ...
        public void SendChat(string message, string room = "lobby") =>
            Send(new NetworkMessage
            {
                ...
                Payload = JsonConvert.SerializeObject(new ChatPayload { Sender = "", Message = message, Room = room })
            });
        ...
        public void RequestLeaderboard() =>
            Send(new NetworkMessage { Type = MessageType.LeaderboardRequest });
